...
open class PublicApiSubtypeBase
class PublicApiSubtypeImpl : PublicApiSubtypeBase()

interface PublicApiSubtypeContract
class PublicApiSubtypeContractImpl : PublicApiSubtypeContract

@Reflective(including = [Includes.PUBLIC_API, Includes.PUBLIC_API_SUBTYPES])
class PublicApiSubtypeRoot {
    fun baseReturn(): PublicApiSubtypeBase = PublicApiSubtypeBase()

    fun contractParam(contract: PublicApiSubtypeContract): PublicApiSubtypeContract = contract

    val exposedField: PublicApiSubtypeContract = PublicApiSubtypeContractImpl()
}

open class PublicApiSupertypeBase
class PublicApiSupertypeImpl : PublicApiSupertypeBase()

@Reflective(including = [Includes.PUBLIC_API, Includes.PUBLIC_API_SUPERTYPES])
class PublicApiSupertypeRoot {
    fun implReturn(): PublicApiSupertypeImpl = PublicApiSupertypeImpl()
}

@Reflective(including = [Includes.PUBLIC_API])
class PublicApiStringRoot {

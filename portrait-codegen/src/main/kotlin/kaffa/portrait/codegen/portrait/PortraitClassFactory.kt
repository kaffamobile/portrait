...
import kaffa.portrait.aot.StaticPortrait
import kaffa.portrait.aot.meta.PClassEntry
import kaffa.portrait.aot.meta.serde.MetadataSerializer
import kaffa.portrait.codegen.PortraitGenerator
import kaffa.portrait.codegen.proxy.ProxyClassFactory
import kaffa.portrait.codegen.utils.interfaceNames
import kaffa.portrait.codegen.utils.superclassNameOrNull
import kaffa.portrait.codegen.utils.toAnnotationEntries
import kaffa.portrait.codegen.utils.toPConstructorEntry
import kaffa.portrait.codegen.utils.toPFieldEntry
import kaffa.portrait.codegen.utils.toPMethodEntry
...
class PortraitClassFactory(
    ...
    private fun generatedClassName(superType: TypeDescription): String {
        ...
        return if (originalName.startsWith("java.")) {
            "kaffa.portrait.generated.jdk.$originalName\$Portrait"
        } else {

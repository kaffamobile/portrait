...
data class ClasslibConfiguration(
    ...
    init {
        fun ensureExists(kind: String, paths: List<Path>) {
            paths.forEach {
...
object ClasslibLocatorFactory {
    fun create(configuration: ClasslibConfiguration): ClassFileLocator {

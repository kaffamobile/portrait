...
class JvmPFieldTest {
    ...
    fun `JvmPField can get and set field values`() {
        val testClassPClass = provider.forName<AnnotatedTestClass>("kaffa.portrait.jvm.AnnotatedTestClass")!!
    ...
    fun `JvmPField handles primitive field types`() {
        val testClassPClass = provider.forName<TestDataClass>("kaffa.portrait.jvm.TestDataClass")!!

...
import kaffa.portrait.e2e.fixtures.*
import kaffa.portrait.portrait
import kaffa.portrait.internal.UnresolvedPClass
...
class BasicReflectionTest {
    ...
    fun testSimpleClassReflection() {
        ...
        assertEquals("kaffa.portrait.e2e.fixtures.SimpleReflectiveClass", pClass.qualifiedName)
    }
    ...
    @Test
    fun testForName() {
        val pClass = Portrait.forName("kaffa.portrait.e2e.fixtures.SimpleReflectiveClass")
    ...
    fun testForNameOrUnresolved() {
        val validClass = Portrait.forNameOrUnresolved("kaffa.portrait.e2e.fixtures.SimpleReflectiveClass")
